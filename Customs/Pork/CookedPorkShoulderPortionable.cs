...
{
    internal class CookedPorkShoulderPortionable : CustomItem
    {
        public override string UniqueNameID => "Cooked Pork Shoulder Portionable";
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("PorkShoulderCookedPortionable");
